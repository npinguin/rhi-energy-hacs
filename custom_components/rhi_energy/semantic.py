...
PROPERTY_DEFINITIONS: Final[dict[str, tuple[SemanticDefinition, ...]]] = {
    "battery_system": (
        ...
        {"input_id":"reserve_write_surface","role":"reserve","property_key":"battery.reserve_soc_pct","fact_key":"battery.reserve_soc_pct","name":"Reserve","unit":"%","kind":"battery","required":False,"platform":"sensor","object_scope":"device","many":False},
    ),
    "grid_connection": (
