...
PROPERTY_DEFINITIONS: Final[dict[str, tuple[SemanticDefinition, ...]]] = {
    ...
    "solar_forecast": (
        ...
        {"input_id":"forecast_current_hour_energy","role":"current_hour_energy","property_key":"forecast.solar_current_hour_kwh","fact_key":"forecast.solar_current_hour_kwh","name":"Current hour forecast","unit":"kWh","kind":"energy","required":False,"platform":"sensor","object_scope":"provider","many":False},
        {"input_id":"forecast_next_hour_energy","role":"next_hour_energy","property_key":"forecast.solar_next_hour_kwh","fact_key":"forecast.solar_next_hour_kwh","name":"Next hour forecast","unit":"kWh","kind":"energy","required":False,"platform":"sensor","object_scope":"provider","many":False},
