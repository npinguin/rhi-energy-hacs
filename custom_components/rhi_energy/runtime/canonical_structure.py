...
HA_MATERIALIZATION_POLICY: dict[str, dict[str, Any]] = {
    ...
    "flexible_loads": {"ha_materialization": True, "topology_kind": "via_device"},
    "grid_connection": {"ha_materialization": True, "topology_kind": "via_device"},
    "grid_phase": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_production": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_inverter": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_inverter_phase": {"ha_materialization": True, "topology_kind": "via_device"},
    "battery_system": {"ha_materialization": True, "topology_kind": "via_device"},
    "battery": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_optimizer_site": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_zone": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_optimizer": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_panel": {"ha_materialization": True, "topology_kind": "via_device"},
    "home_consumption": {"ha_materialization": True, "topology_kind": "via_device"},
    "flexible_load": {"ha_materialization": True, "topology_kind": "via_device"},
    "gas_meter": {"ha_materialization": True, "topology_kind": "via_device"},
    "solar_forecast": {"ha_materialization": True, "topology_kind": "via_device"},
    "price_source": {"ha_materialization": True, "topology_kind": "via_device"},
}
