...
async def async_get_config_entry_diagnostics(hass: HomeAssistant, entry: ConfigEntry):
    ...
    return {
        ...
        "layered_model": {
            ...
            "layer_health": deepcopy(model.get("layer_health") or snap.get("layer_health") or {}),
            ...
            "system_assets": deepcopy(model.get("system_assets") or []),
            "planning_assets": deepcopy(model.get("planning_assets") or []),
            "intelligence_assets": deepcopy(model.get("intelligence_assets") or []),
