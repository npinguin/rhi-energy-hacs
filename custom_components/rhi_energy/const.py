"""Constants for RHI Energy E0.15.17 energy balance/planning semantics closure on Shared Baseline 1.8.1."""
DOMAIN = "rhi_energy"
DOMAIN_ID = "energy"
RELEASE = "E0.15.17"
RELEASE_NAME = "ENERGY_BALANCE_PLANNING_SEMANTICS_CLOSURE"
