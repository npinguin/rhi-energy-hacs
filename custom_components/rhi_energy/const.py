"""Constants for RHI Energy E0.15.6 runtime system flow source topology closure on Shared Baseline 1.8.1."""
DOMAIN = "rhi_energy"
DOMAIN_ID = "energy"
RELEASE = "E0.15.6"
RELEASE_NAME = "RUNTIME_SYSTEM_FLOW_SOURCE_TOPOLOGY_CLOSURE"
