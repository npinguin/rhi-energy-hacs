...
- GitHub releases: immutable versioned distributions for reproducible install and rollback; production approval is governed separately by the private engineering repository.
- `DISTRIBUTION_SOURCE.json`: exact private source commit, Energy release, shared baseline and runtime aggregate checksum for the current candidate.
